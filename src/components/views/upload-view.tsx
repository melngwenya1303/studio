                     ...
                     <Card className="shadow-lg flex flex-col h-full m-4 rounded-2xl">
                        ...
                        <CardContent className="flex flex-col flex-grow">
                             <div className="space-y-6 py-6 flex-grow">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-xl font-semibold font-headline">3. Choose Mockup Color</h3>
                            ...
                            <div className="mt-auto pt-4 space-y-3">
                                <div className="flex gap-3">
                                    ...
                                    <Button disabled={!uploadedImage} className="w-full bg-green-600 hover:bg-green-700">Finalize Design</Button>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
