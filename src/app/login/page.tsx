...
export default function LoginPage() {
    ...
    const [email, setEmail] = useState('admin@surfacestory.ai');
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-gray-100 dark:bg-background p-4 overflow-hidden">
             <div className="absolute inset-0 z-0 opacity-10 dark:opacity-20">
                <div className="absolute h-[500px] w-[500px] rounded-full bg-primary/30 -top-48 -left-52 blur-3xl"></div>
                <div className="absolute h-[400px] w-[400px] rounded-full bg-accent/30 -bottom-60 -right-40 blur-3xl"></div>
            </div>
            <motion.div 
                ...
                <Card className="w-full max-w-md shadow-2xl bg-card/80 backdrop-blur-lg">
                    <CardHeader className="text-center">
                         <div className="w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-2xl flex items-center justify-center shadow-lg mx-auto mb-4">
                            <Icon name="Wand2" className="w-8 h-8 text-primary-foreground" />
                        </div>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            ...
                            <Button onClick={() => handleAuthAction('signUp')} className="w-full" variant="secondary" disabled={isLoading || !email || !password}>
